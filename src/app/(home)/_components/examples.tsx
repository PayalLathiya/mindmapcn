...
export function Examples() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 animate-fade-in delay-400 auto-rows-[22rem] lg:auto-rows-[20rem]">
      ...
      <OrganizationalChart className="sm:col-span-2 lg:col-start-1 lg:col-end-3 lg:row-start-1 lg:row-end-3" />

      {/* Widget 2: Project Planning */}
      <ProjectPlanning className="lg:col-start-3 lg:col-end-4 lg:row-start-1 lg:row-end-2" />

      {/* Widget 3: Knowledge Graph */}
      <KnowledgeGraph className="lg:col-start-3 lg:col-end-4 lg:row-start-2 lg:row-end-3" />
      ...
      <DecisionTree className="lg:col-start-2 lg:col-end-4 lg:row-start-3 lg:row-end-4" />
    </div>
  );
}
